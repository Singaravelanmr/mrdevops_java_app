resource "aws_iam_role" "velans_eks_node_role" {
...
resource "aws_iam_role_policy_attachment" "AmazonEKSWorkerNodePolicy" {
  ...
  role       = aws_iam_role.velans_eks_node_role.name
}
...
resource "aws_eks_node_group" "velans_node_group" {
  cluster_name    = var.cluster_name
  node_group_name = var.node_group_name
  node_role_arn   = aws_iam_role.velans_eks_node_role.arn
